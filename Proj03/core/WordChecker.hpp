...
public:
    ...
    void swapper(std::vector<std::string> &suggestions, std::string word) const;


    void inserter(std::vector<std::string> &suggestions, std::string word) const;


    void deleter(std::vector<std::string> &suggestions, std::string word) const;


    void replacer(std::vector<std::string> &suggestions, std::string word) const;


    void splitter(std::vector<std::string> &suggestions, std::string word) const;   
