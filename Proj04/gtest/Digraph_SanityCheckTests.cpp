...
TEST(Digraph_SanityChecks, canMoveConstructFromExpiringDigraph)
{
    Digraph<int, int> d1;
    Digraph<std::string, std::string> d2;
...
TEST(Digraph_SanityChecks, canMoveAssignFromExpiringDigraph)
{
    Digraph<int, int> d1;
    Digraph<std::string, std::string> d2;

    Digraph<int, int> dd1;
    Digraph<std::string, std::string> dd2;
